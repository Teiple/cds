...
/*
    ...
    Cmdline:
        sokol-shdc -i shaders/unlit.glsl -o shaders/unlit.odin -l glsl430:glsl300es:metal_macos:hlsl5:wgsl -f sokol_odin
...
unlit_shader_desc :: proc "c" (backend: sg.Backend) -> sg.Shader_Desc {
	desc: sg.Shader_Desc
